...
insert into child values(null,5000,'Teker','Ali');
...
Delete From parent Where vergi_nosu=101;
--ERROR:  column "vergi_nosu" does not exist
--LINE 1: Delete From parent Where vergi_nosu=101;
                                 ^
--HINT:  Perhaps you meant to reference the column "parent.vergi_no".
--SQL state: 42703
--Character: 26
...
--Aynı zamanda parent tablo da komple silinmek isterse cascade ekleyerek parent tablo silinebildi.
